...
insert into deliveryperson values (501,'Mark',9876543217,'MH27AB7899','klayani Nagar Pune','Mark','Mark@123','mark@gmail.com',5);
insert into deliveryperson values (502,'Axel',9876343211,'MH27AB7999','Rathi Nagar Amravati','Axel','Axel@123','axel@gmail.com',4);
insert into deliveryperson values (503,'Robin',9876543245,'MH27AB5899','Malagi Nagar Nagpur','Robin','Robin@123','robin@gmail.com',3);
insert into deliveryperson values (504,'Midoria',9876543234,'MH27AB7399','Viman Nagar Pune','Midoria','Midoria@123','midoria@gmail.com',2);
insert into deliveryperson values (505,'Bakugo',9876543207,'MH27AB5799','Galge Nagar Amravati','Bakugo','Bakugo@123','bakugo@gmail.com',1);
...
insert into restaurant values(102,"Vaishali","Fergusson College Rd, Rage Path, Ganeshwadi, Shivajinagar, Pune, Maharashtra 411004","Veg",25531244,"Being a legend in serving South-Indian food.",73.84118631947064,18.521057325093537,"0700","2300" ,2);
insert into restaurant values(103,"Kalyani Veg Restaurant","Fortaleza Complex, 5, Central Ave, Princeton Town Society, Prathamesh Society, Kalyani Nagar, Pune, Maharashtra 411006","Veg",64004965,"Variety of Vegetarian delicacies",73.90560786361056,18.545872886091242,"0800","2300",4);
insert into restaurant values(104,"McDonald's","Marigold Complex, Sy No 15, Gr floor, Kalyani Nagar - Wadgaon Sheri Rd, Pune, Maharashtra 411015","Veg/Non-Veg",8928304027,"Classic,long-running fast-food chain ",73.90631036854177,18.545834792860852,"1000","2200",1);
insert into restaurant values(105,"Burger King","S 25, 2nd Flr, Phoenix Market City Mall, Viman Nagar Rd, Pune, Maharashtra 411013","Veg/Non-Veg",2048624150,"chain serving grilled burgers, fries & shakes, plus breakfast.",73.91687694340567,18.562320325794715,"1000","2300",3);
insert into restaurant values(106,"Wadeshwar","Landmark Garden, Sr No 16/1, Mulik Nagar, Opposite, Society, Kalyani Nagar, Pune, Maharashtra 411006","Veg",9607008956,"Informal venue for quick serve Indian snacks ",73.90614605504875,18.549163759725843,"0730","2300",4);
insert into restaurant values(107,"RamKrishna Restaurant","6, Moledina Road, Opposite Westend Theatre, Camp, Pune, Maharashtra 411001","Veg",9607008956,"Dishes from across India are prepared with the absence of meat", 73.87862792698594,18.519730768515373,"1100","2200",2);
insert into restaurant values(108,"Shreemant Veg NonVeg Family Restaurant","R Pathare Galaxy, Kharadi Magarpatta Bypass Rd Sainathnagar Chowk, Kharadi, next to Columbia Asia hospital, Pune, Maharashtra 411014","Veg/Non-Veg",9707008756,"A trusted place to savor the authentic food delicacies",73.9338807865372,18.54369396078154,"0700","2300",4);
