...
<div class="container-fluid course-container">
  <div class="row">
    ...
    <div class="progress">
    <div class="progress-bar" role="progressbar" style="max-width:<%=progress %>%">
        ...
        <div class="row">
          <div class="container-fluid">
            <video
              ...
              controls
            >
              <source src='<%=session.getAttribute("subcourse_url") %>' type='video/mp4' />
        ...
        <div class="row">
          <div class="container-fluid btn-control">
            <!-- <a href="#" class="btn btn-primary">Prev</a> -->
              ...
              class='btn <%=prev_video<1? "disabled" : "" %>'"
              >prev</a>
            <a
              href="<%=request.getContextPath()%>/UserController/start-course/<%=next_video%>"
              class='btn  <%=next_video>videoCount_int? "disabled" : "" %>'"
              >Next</a>
          </div>
        </div>
        </div>
